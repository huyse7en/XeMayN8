...
public class PurchaseStatistics extends javax.swing.JPanel {
    ...
    public void renderPreciousPanel() {
        ...
        if (cboxChooseYear.getItemCount() == 0) {
            ...
            tblSanPham.setList(new ArrayList<>());
        ...
        try {
            ...
            tblSanPham.setList(bookList != null ? bookList : new ArrayList<>());
    ...
    public void resetPreciousPanel(){
        ...
        tblSanPham.renderPurchaseQuantiyTable();
    ...
    private void initComponents() {
        ...
        tblSanPham = new GUI.Component.Panel.Statistics.Components.PurchaseBookTable();
        ...
        lblBookHeader.setText("Xe đã nhập");
        ...
        lblBookTab.setText("Xe được nhập");
    ...
    private void cboxChooseYearItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cboxChooseYearItemStateChanged
        ...
        tblSanPham.setList(bookListInYear);
    ...
    private void radSumFeeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_radSumFeeMouseClicked
        ...
        tblSanPham.renderPurchaseFeeTable();
    ...
    private GUI.Component.Panel.Statistics.Components.PurchaseBookTable tblSanPham;
    ...
    public static void main(String[] args)
    {
        ...
        PurchaseStatistics sp =new PurchaseStatistics();
